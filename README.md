...
Приложение получает случайно сгенерированные пачки билетов от сервера, фильтрует и сортирует билеты в реальном времени, после чего показывает 5 первых результатов
